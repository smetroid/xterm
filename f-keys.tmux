...
bind-key -n M-F5 run-shell '$BYOBU_PREFIX/libexec/byobu/include/toggle-utf8' \; source $BYOBU_PREFIX/share/byobu/profiles/tmuxrc
bind-key -n S-F5 new-window -k "$BYOBU_PREFIX/libexec/byobu/include/cycle-status" \; source $BYOBU_PREFIX/share/byobu/profiles/tmuxrc
...
bind-key -n M-F6 run-shell '$BYOBU_PREFIX/libexec/byobu/include/tmux-detach-all-but-current-client'
...
bind-key -n S-F9 command-prompt -p "Send command to all panes:" "run-shell \"$BYOBU_PREFIX/libexec/byobu/include/tmux-send-command-to-all-panes '%%'\""
bind-key -n C-F9 command-prompt -p "Send command to all windows:" "run-shell \"$BYOBU_PREFIX/libexec/byobu/include/tmux-send-command-to-all-windows '%%'\""
